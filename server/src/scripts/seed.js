...
async function main() {
  ...
  const catalog = [
    ['BAT-LFP-60', '6341727100289', 'Spiro Battery 60V 30Ah LFP', 'Spare part', 'Spiro', 'Spiro Uganda', 1450000, 1890000, 14, 5, 8],
    ['BAT-LFP-32', '6341727100296', 'Spiro Battery 32Ah LFP', 'Spare part', 'Spiro', 'Spiro Uganda', 920000, 1240000, 9, 4, 6],
    ['CHR-60V', '6341727100302', '60V Smart Charger', 'Accessory', 'Spiro', 'Spiro Uganda', 210000, 295000, 25, 6, 10],
    ['TYR-9090', '6341727100319', 'Tubeless Tyre 90/90-12', 'Spare part', 'MRF', 'MRF Tyres UG', 95000, 145000, 42, 10, 15],
    ['TYR-1008', '6341727100326', 'Tubeless Tyre 100/80-10', 'Spare part', 'MRF', 'MRF Tyres UG', 88000, 135000, 3, 6, 8],
    ['BRK-PAD-F', '6341727100333', 'Front Brake Pads Set', 'Spare part', 'Spiro', 'Spiro Uganda', 24000, 45000, 60, 15, 20],
    ['BRK-PAD-R', '6341727100340', 'Rear Brake Shoes', 'Spare part', 'Spiro', 'Spiro Uganda', 26000, 48000, 2, 10, 15],
    ['CTL-DCDC', '6341727100357', 'DC-DC Converter 60V→12V', 'Spare part', 'Spiro', 'Spiro Uganda', 130000, 198000, 11, 4, 6],
    ['CTL-HRN', '6341727100364', 'Main Wiring Harness', 'Spare part', 'Spiro', 'Spiro Uganda', 165000, 240000, 6, 3, 5],
    ['MTR-3000', '6341727100371', 'Hub Motor 3000W', 'Spare part', 'Spiro', 'Spiro Uganda', 1150000, 1520000, 4, 2, 3],
    ['MTR-2000', '6341727100388', 'Hub Motor 2000W', 'Spare part', 'Spiro', 'Spiro Uganda', 980000, 1320000, 2, 2, 3],
    ['SUS-FRK', '6341727100395', 'Front Fork Assembly', 'Spare part', 'Spiro', 'Spiro Uganda', 310000, 420000, 7, 3, 5],
    ['LGT-LED-H', '6341727100401', 'LED Headlamp Unit', 'Accessory', 'Spiro', 'Spiro Uganda', 72000, 118000, 18, 5, 8],
    ['LGT-LED-T', '6341727100418', 'LED Tail Light', 'Accessory', 'Spiro', 'Spiro Uganda', 31000, 56000, 22, 6, 10],
    ['MIR-L', '6341727100425', 'Mirror Left', 'Accessory', 'Spiro', 'Spiro Uganda', 15000, 28000, 35, 8, 12],
    ['MIR-R', '6341727100432', 'Mirror Right', 'Accessory', 'Spiro', 'Spiro Uganda', 15000, 28000, 31, 8, 12],
    ['HLM-XXL', '6341727100439', 'Rider Helmet XL', 'Accessory', 'Generic', 'Safeway Accessories', 85000, 135000, 16, 4, 6],
    ['GLV-RID', '6341727100446', 'Riding Gloves', 'Accessory', 'Generic', 'Safeway Accessories', 22000, 38000, 28, 6, 10],
    ['CHN-428', '6341727100453', 'Drive Chain 428H', 'Spare part', 'Generic', 'Spiro Uganda', 48000, 79000, 0, 4, 6],
    ['BLT-BELT', '6341727100460', 'Drive Belt', 'Spare part', 'Generic', 'Spiro Uganda', 38000, 64000, 13, 4, 6],
    ['RGU-MUD', '6341727100477', 'Rear Mudguard', 'Spare part', 'Spiro', 'Spiro Uganda', 29000, 52000, 12, 4, 6],
    ['GRIP-PR', '6341727100484', 'Handlebar Grip Pair', 'Consumable', 'Generic', 'Safeway Accessories', 8000, 16000, 44, 10, 15],
    ['FUS-30A', '6341727100491', 'Fuse 30A', 'Consumable', 'Generic', 'Spiro Uganda', 3000, 7000, 90, 20, 30],
    ['BLB-12V', '6341727100507', '12V Bulb', 'Consumable', 'Generic', 'Spiro Uganda', 4000, 9000, 1, 10, 15],
  ];
  const products = [];
